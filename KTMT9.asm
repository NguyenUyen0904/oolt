...
NhapMang:
	...
	la $a2,16# gioi han do dai laf 16 ki tu  
	syscall# nhap ten
...
Continue1:	
	sw $a0,0($s3)# cat dia chi cua s3 vao thanh ghi a0
...
for:	add $s5,$s4, $0 #s5=s4
	...
	bne $t7,$0,print_char # n?u t7!=0(hay t7=1) thì nhay sang lenh print_char
